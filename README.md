...
- **Turkish PII Masking & Bi-Directional Restoration (KVKK-Aligned)**:
  ...
  - **Multiple Masking Modes**:
    ...
    - `anonymize`: Category label redaction replacing sensitive data with uppercase entity tags (`[AD]`, `[TCKN]`, `[SIFRE]`, `[IBAN]`).
